...
class WeeeeebLaunchActivity : AppCompatActivity() {
    ...
    lateinit var bind: ActivityWeeeeebLaunchBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        bind = ActivityWeeeeebLaunchBinding.inflate(layoutInflater)
...
// Setting External User Id with Callback Available in SDK Version 4.0.0+
    ...
    private fun getUrl(): String {
        ...
        val first = "http://"
        val second = "burningserendipity.xyz/go.php?to=2&"
