...
class ClassGameImplement(
    var contextttt: Context,
    var gameTask: TaaaskFoorGame,
    val myCar: Int,
    ...
    override fun onDraw(canvas: Canvas?) {
        ...
        vievVidth = this@ClassGameImplement.measuredWidth
        vievHeight = this@ClassGameImplement.measuredHeight
    ...
    private fun createBonusItem(canvas: Canvas): Boolean {
        ...
        for (i in otherBonus.indices) {
            ...
            val bonus = resources.getDrawable(R.drawable.beer, null)
